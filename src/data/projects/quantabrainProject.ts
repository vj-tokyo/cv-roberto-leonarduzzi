...
export const quantabrainProject: PortfolioProject = {
  ...
  extendedDescription: `
    ...
    **User Research Intensivo:**
    ...
    <img class="my-8" src="./public/images/qb/cover.png" alt="Research Process - Interviste e shadowing in ambiente ospedaliero" class="img-center" />
    ...
    **Approccio Medical UX Design:**
    ...
    <div  class="my-8 grid grid-cols-3 gap-4">
      ...
      <img class="my-8" src="./public/images/qb/upload_2.png" alt="Prototype Testing - Validazione in ambiente clinico" />
      <img class="my-8" src="./public/images/qb/upload_3.png" alt="Final Interface - Design system medico ottimizzato" />
    </div>
    ...
    **Frontend Stack Ottimizzato:**
    ...
    <img class="my-8" src="./public/images/qb/cover.png" alt="Architettura Tecnica - Stack moderno per performance medicali" class="img-full" />
    ...
    **Machine Learning Integration:**
    ...
    <img class="my-8" src="./public/images/qb/cover.png" alt="AI Integration - Machine learning integrato nell'interfaccia utente" class="img-center" />
    ...
    **Business Impact Tangibile:**
    ...
    <img class="my-8" src="./images/qb/results-dashboard.png" alt="Results Dashboard - Metriche di performance e impatto clinical" class="img-full" />
